    ...
    <v-app-bar color="#02218f" height="fit-content">
      <v-container fluid>
        <v-row>
          ...
          <v-col cols="4">
            <div class="parent d-flex justify-space-between align-center">
              ...
              <div class="wishlistes d-flex flex-column align-center">
                <svg
                  viewBox="0 0 512 512"
                  class="icon icon-wishlist"
                  style="fill: #ffb547; width: 30px"
                >
                  <g>
                    <g>
                      <path
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
                ...
                <span style="color: #ffb547">Wishlistes</span>
              </div>
              ...
              <div class="wishlistes d-flex flex-column align-center">
                <svg
                  ...
                  style="fill: #ffb547; width: 30px"
                >
                  <title style="color: #ffb547">user</title>
                  <path
                    class="path1"
        ...
        <v-row>
          ...
          <v-col cols="5" class="d-flex justify-end" style="gap: 40px">
